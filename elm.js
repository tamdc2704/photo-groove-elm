...
var author$project$PhotoGroove$ClickedSuppriseMe = {$: 'ClickedSuppriseMe'};
...
var author$project$PhotoGroove$ChooseSize = function (a) {
	return {$: 'ChooseSize', a: a};
};
				...
				[
					...
					_List_fromArray(
						[
							...
							author$project$PhotoGroove$ChooseSize(size)),
							elm$html$Html$Attributes$checked(
							_Utils_eq(choosenSize, size))
						]),
					_List_Nil),
					elm$html$Html$text(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$Events$onClick(author$project$PhotoGroove$ClickedSuppriseMe)
					]),
				_List_fromArray(
					[
						elm$html$Html$text('Supprise me!')
					])),
				A2(
				elm$html$Html$h3,
				_List_Nil,
